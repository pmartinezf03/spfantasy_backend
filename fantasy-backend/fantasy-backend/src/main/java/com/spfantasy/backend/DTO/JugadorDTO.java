...
public class JugadorDTO {
    ...
    public Integer getTl() { return tl; }
    public Integer getT2() { return t2; }
    public Integer getT3() { return t3; }
    public Integer getFp() { return fp; }
    public Long getPropietarioId() { return propietarioId; }  // ✅ Nuevo
    public String getPropietarioUsername() { return propietarioUsername; }  // ✅ Nuevo
    ...
    public void setTl(Integer tl) { this.tl = tl; }
    public void setT2(Integer t2) { this.t2 = t2; }
    public void setT3(Integer t3) { this.t3 = t3; }
    public void setFp(Integer fp) { this.fp = fp; }
    public void setPropietarioId(Long propietarioId) { this.propietarioId = propietarioId; }  // ✅ Nuevo
    public void setPropietarioUsername(String propietarioUsername) { this.propietarioUsername = propietarioUsername; }  // ✅ Nuevo
